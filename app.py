...
with st.sidebar:
    ...
    # Fixing the spill-over by stacking the text
...
if page == "Home":
    ...
    st.markdown("<br>", unsafe_allow_html=True) # Adds a clean space
    
    # Creating a two-column layout to break up the text block
    ...
    with col2:
        st.subheader("Our Sector Mandate")
        st.markdown("""
    ...
    # Using a bordered container for the coverage universe to make it pop
    with st.container(border=True):
        st.subheader("Coverage Universe")
        st.markdown("""
